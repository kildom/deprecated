...
export function parseModule(moduleBinary: Uint8Array, currentMemory: Uint8Array, currentStackPointer: number, sizeOptimize: boolean) {
...
export function parseModule2(moduleBinary: Uint8Array) {
