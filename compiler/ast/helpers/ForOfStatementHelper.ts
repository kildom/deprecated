...
export type AstForOfStatementContainers = AstProgram | AstBlockStatement | AstWithStatement | AstLabeledStatement | AstIfStatement | AstSwitchCase | AstWhileStatement | AstDoWhileStatement | AstForStatement | AstForInStatement | AstForOfStatement | AstStaticBlock;

export type AstForOfStatementComponents = AstVariableDeclaration | AstPattern | AstExpression | AstStatement;
