...
export type AstObjectPatternContainers = AstFunction | AstCatchClause | AstForInStatement | AstFunctionDeclaration | AstVariableDeclarator | AstFunctionExpression | AstAssignmentExpression | AstForOfStatement | AstArrowFunctionExpression | AstAssignmentProperty | AstArrayPattern | AstRestElement | AstAssignmentPattern | AstAnonymousDefaultExportedFunctionDeclaration;
